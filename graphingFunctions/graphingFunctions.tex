...
\begin{image}
  \begin{tikzpicture}
	...
	\begin{axis}[
          ...
          \addplot [thick, penColor, smooth,domain=(-5:-1.01)] {x/(x^2-1)};
          \addplot [thick, penColor, smooth,domain=(-0.99:0.99)] {x/(x^2-1)};
          \addplot [thick, penColor, smooth,domain=(1.01:5)] {x/(x^2-1)};
        \end{axis}
\end{tikzpicture}
\end{image}
