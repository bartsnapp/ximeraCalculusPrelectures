...
On the interval $(0,2)$ $f$ is
 ...
 \begin{question}
 	The first zero of $f$ is $x=$ \answer{-sqrt(12)}
 \end{question}
 
  \begin{question}
 	The second zero of $f$ is $x=$ \answer{0}
 \end{question}
 
  \begin{question}
 	The last zero of $f$ is $x=$ \answer{sqrt(12)}
 \end{question}
...
\begin{image}
  \begin{tikzpicture}
	...
	\begin{axis}[
          ...
          \addplot [thick, penColor, smooth,domain=(-5:5)] {x^3-12*x};
