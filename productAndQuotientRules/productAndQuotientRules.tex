...
\outcomes{How do you find the derivative of a product?}
\outcomes{How do you find the derivative of a quotient?}
\outcomes{Use the product rule to calculate derivatives}
\outcomes{Use the quotient rule to calculate derivatives}
